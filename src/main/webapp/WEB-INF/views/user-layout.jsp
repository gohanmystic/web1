<%@page import="vn.com.fsoft.common.Constants"%>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="<%= requestURI.equalsIgnoreCase("/OnlineQuiz") ? "active" : "" %>">
                        <a href="${contextPath}">
                            <span>Home</span>
                        </a>
                    </li>
                    <li class="<%= requestURI.contains("/OnlineQuiz/question") ? "active" : "" %>">
                        <a href="javascript:void(0);" class="menu-toggle">
                            <span>Question management</span>
                        </a>
                        <ul class="ml-menu">
                            <li class="<%= requestURI.equalsIgnoreCase("/OnlineQuiz/question/list") ? "active" : "" %>">
                                <a href="${contextPath}/question/list">Question list</a>
                            </li>
                            <li class="<%= requestURI.equalsIgnoreCase("/OnlineQuiz/question/create") ? "active" : "" %>">
                                <a href="${contextPath}/question/create">Create question</a>
                            </li>
                        </ul>
                    </li>
                    <li class="<%= requestURI.contains("/OnlineQuiz/test") ? "active" : "" %>">
                        <a href="javascript:void(0);" class="menu-toggle">
                            <span>Test management</span>
                        </a>
                        <ul class="ml-menu">
                            <li class="<%= requestURI.equalsIgnoreCase("/OnlineQuiz/test/list") ? "active" : "" %>">
                                <a href="${contextPath}/test/list">Test list</a>
                            </li>
                            <li class="<%= requestURI.equalsIgnoreCase("/OnlineQuiz/test/create") ? "active" : "" %>">
                                <a href="${contextPath}/test/create">Create test</a>
                            </li>
                        </ul>
                    </li>
                </ul>
